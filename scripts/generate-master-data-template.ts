...
const readmeLines: [string, string][] = [
  ...
  ["li", "Format: CC-MM-NNNNNN, e.g. AP-BX-000001"],
  ["li", "CC must match the row's CommodityCode; MM must match its MaterialCategoryCode"],
  ["li", "NNNNNN is a 6-digit number, 000001 to 999999. Gaps are fine; duplicates are not."],
  ...
  ["li", "Put the file name in the ImageFile column of 7-Items, e.g. AP-BX-000001.jpg"],
